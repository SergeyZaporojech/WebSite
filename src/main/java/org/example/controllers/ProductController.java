...
public class ProductController {
    ...
    public ResponseEntity<ProductItemDTO> create(@ModelAttribute ProductCreateDTO dto)
    {
        ...
        for (MultipartFile image : dto.getImages()) {
            var imageSave = storageService.saveImageFormatFile(image, FileSaveFormat.WEBP);
    ...
    public ResponseEntity<ProductEntity> updateProduct(@PathVariable int id, @ModelAttribute ProductUpdateDTO dto) {
        ...
        if (existingProduct.isPresent()) {
            ...
            for (MultipartFile image : dto.getImages()) {
                String fileName = storageService.saveImageFormatFile(image, FileSaveFormat.WEBP);
