...
//створюємо буфер для нової фотографії, де важливо вказуємо розширення яке буде у фотки та розмір (32х32, 150х150)
    ...
    @Override
    public String saveImageFormatFile(MultipartFile file, FileSaveFormat format) {
        try {
            String extetion = format.name().toLowerCase();
            String randomFileName= UUID.randomUUID().toString()+"."+extetion;
